...
import { DEFAULT_BG_COLOR } from "../constanst";
...
export const SearchFilters = () => {
  ...
  return (
    <div className="px-4 lg:px-12 py-8 flex flex-col gap-4 w-full" style={{backgroundColor : activeCategoryColor}}>
      <SearchInput />
...
export const SearchFiltersLoading = () => {
  return (
      ...
      <div className="px-4 lg:px-12 py-8 flex flex-col gap-4 w-full" style={{backgroundColor : "#F5F5F5"}}>
